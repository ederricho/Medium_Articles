...
We will also use the normality assumption confidence interval with $\alpha = 0.05$. None of the distributions of the variables are normal, but many times we assume the distribution is normal without even knowing we are making that assumption by using the 'wrong' confidence interval method. We will not use the median of the sample either, since these methods call for the mean.
